...
% Segmentation pour déterminer D
D = (u0(:, 1) > 0.8) & (u0(:, 2) > 0.8) & (u0(:, 3) < 0.15); % "grenouille_avec_texte.png"
% D = (u0(:, 1) > 160/255) & (u0(:, 2) < 80/255) & (u0(:, 3) < 50/255); % "grenouille_avec_texte_relou.png"
